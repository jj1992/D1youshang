/*--------首页-我的账户-划入事件------------*/
//$(function(){
//	$('.zh').mouseenter(function(){
//		$('.zh_box').css('display','block');
//	})
//	$('.zh').mouseleave(function(){
...
//		$sc.attr('src',"http://www.d1.com.cn/ajax/search/hotkeys.jsp?q=" + $(this).val() + "&contentType=fn");
...
/*------首页轮播图-------*/
//$(function(){
//	$.getJSON('../dist/json/index.json',function(data){
//		var arr = data.banner;
//		var str;
...
//$(window).scroll(function(){
//	if($('.mainNav_b').scrollTop() >= 300){
//		$('.mainNav_b').css({'position':'fixed','top':0,'left':0});
//	}
//})
